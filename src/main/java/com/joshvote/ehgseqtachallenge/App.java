...
public class App {
    ...
    // these themes dont conform to the challenge - they dont cover the full range
    // of values - they just look nifty
    ...
    /**
     * generates the config from the command line args. Returns null if args are
     * invalid
     * 
     * @param args
     * @return
