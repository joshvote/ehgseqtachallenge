...
public class TextImageMask implements ImageMask {
    ...
    /**
     * Builds a text image mask from an existing buffered image. Any pixel with a
     * non black color will be considered as being mask = true
     * 
     * @param src
     * @param imageConfig
     */
    ...
    /**
     * Calculates the optimal image size for a given aspectRatio and the constant
     * TotalPixels
     * 
    ...
    public static ImageConfiguration calculateOptimalImageSize(double aspectRatio) {
         ...
         * gogo gadget algebra
         * 
         * width * height = totalPixels width / height = aspectRatio
         * 
         * height = totalPixels / width width / (totalPixels / width) = aspectRatio =>
         * width = sqrt(totalPixels * aspectRatio) height = totalPixels / width
         * 
         */
     ...
     * 
     * In a "real" app this would probably be offloaded to a dedicated factory to
     * better seperate concerns and ease testing
     * 
     * @param text
     * @param font
     * @param totalPixels
